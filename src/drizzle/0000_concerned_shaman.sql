...
CREATE INDEX "user_subscription_table.clerk_user_id_index" ON "user_subscriptions" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX "user_subscription_table.strpe_customer_id_index" ON "user_subscriptions" USING btree ("stripe_customer_id");